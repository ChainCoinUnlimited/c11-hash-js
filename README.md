...
> Performs the c11 hash.

## Installation
```
$ npm install --save c11-hash-js
```

## Usage

```js
var c11 = require('c11-hash-js');

c11.c11('The great experiment continues.');
// -> '4da3b7c5ff698c6546564ebc72204f31885cd87b75b2b3ca5a93b5d75db85b8c'

c11.blake('The great experiment continues.');
...
c11.bmw('The great experiment continues.');
...
c11.cubehash('The great experiment continues.');
...
c11.echo('The great experiment continues.');
...
c11.groestl('The great experiment continues.');
...
c11.jh('The great experiment continues.');
...
c11.keccak('The great experiment continues.');
...
c11.luffa('The great experiment continues.');
...
c11.shavite('The great experiment continues.');
...
c11.simd('The great experiment continues.');
...
c11.skein('The great experiment continues.');
...
### c11(str,input,output)

#### str

Type: `string` (input 0), 8 bit `array` (input 1), 32 bit `array` (input 2)

Get the c11 hash as `string` (output 0), a 8 bit `array` (output 1), a 32 bit `array` (output 2).